...
describe('factory: ValueAPI', function() {
  ...
  // Make sure all values by category method is defined
  describe('method ValueAPI.getAllValuesSortedByCategory toBeDefined', function() {
  	it('should be defined', function() {
  		expect(ValueAPI.getAllValuesSortedByCategory).toBeDefined();
  	})
  })

  // Make sure getAllValuesSortedByCategory method works as planned
  describe('method ValueAPI.getAllValuesSortedByCategory toEqual', function() {
